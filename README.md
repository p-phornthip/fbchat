...
### This project no longer works as facebook has shut it's chat api down, please don't refer this code. There is no way one can send messages from outside of facebook anymore.
